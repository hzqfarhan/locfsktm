  ...
  <div class="footer-top">
    ...
    <div class="footer-contributors-col">
      ...
      <div class="contributors-grid">
        ...
        <!-- Contributor: Aizat (@muhammadaizat0185) -->
        <a href="https://github.com/muhammadaizat0185" target="_blank" rel="noopener noreferrer" class="contributor-card" title="GitHub: muhammadaizat0185">
          <div class="contributor-avatar-wrap">
            <img 
              src="https://github.com/muhammadaizat0185.png" 
              alt="muhammadaizat0185 avatar" 
              class="contributor-avatar" 
              loading="lazy" 
              onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/u/258392918?v=4';" 
            />
            <div class="contributor-online-dot" title="Active Contributor"></div>
          </div>
          <div class="contributor-info">
            <span class="contributor-name">Aizat</span>
            <span class="contributor-handle">@muhammadaizat0185</span>
          </div>
          <div class="contributor-link-icon" aria-hidden="true">
            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link">
              <path d="M15 3h6v6"></path>
